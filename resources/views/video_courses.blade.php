    ...
    <script>
        ...
        $('.dynamic3').change(function() {
            if ($(this).val() != '') {
                ...
                html += '<section class="light"><div class="container py-2"><article class="postcard light green"><a class="postcard__img_link" href="#"><iframe class="postcard__img" src="' + value.videolink + '?autoplay=1&mute=1"  allowfullscreen></iframe></a><div class="postcard__text t-dark"><h1 class="postcard__title blue"><a href="#">' + value.videoheading + '</a></h1><div class="postcard__subtitle small"><ul class="postcard__tagbox"><li class="tag__item">' + value.class_name + '</li<li class="tag__item">' + value.course_name + '</li><li class="tag__item">' + value.subject_name + '</li><br><li class="tag__item">' + value.videoby + '</li>';
                  $.each(response.explode, function( index, value ) {
                  
                    html += '<li class="tag__item"><a style="color:#0930f1" href="#'+ value + '">' + value + '</a></li>';
                  });
                 
                  html += '</ul></div><div class="postcard__bar"></div><div class="postcard__preview-txt">' + value.videodescription + '</div></article></div> </section>'
            });
